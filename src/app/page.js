          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            <div>
              ...
              <h1 style={{
                ...
                Where Code<br/>
                <span style={{ color: 'var(--accent-blue)' }}>Meets the Page</span>
              </h1>
      ...
      <section style={{ padding: '100px 32px', background: 'var(--bg-secondary)', borderTop: '1px solid var(--border)' }}>
        <div style={{ maxWidth: 'var(--max-width)', margin: '0 auto' }}>
            ...
            {[
              {
                ...
                desc: 'Custom web and desktop applications, APIs, automation tools, and cloud solutions — built to your specifications.',
                color: '#00AAFF',
              },
              {
                icon: '📖',
                title: 'Book Publishing',
                desc: 'From manuscript to finished book — editing, layout, design, and distribution support for authors and publishers.',
                color: '#7B5EFA',
              },
              {
                icon: '✍️',
                title: 'Article Publishing',
                desc: 'Professional editorial services for articles, reports, and digital content — structured, polished, and ready to publish.',
                color: '#00C98D',
              },
            ].map(service => (
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = service.color; e.currentTarget.style.transform = 'translateY(-4px)'; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.transform = 'translateY(0)'; }}
              >
                <div style={{ fontSize: '36px', marginBottom: '20px' }}>{service.icon}</div>
                <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '22px', fontWeight: 700, marginBottom: '12px', color: service.color }}>{service.title}</h3>
          ...
          <div style={{ textAlign: 'center', marginTop: '48px' }}>
            <Link href="/services" style={{
              color: 'var(--accent-blue)', fontSize: '15px', fontWeight: 500,
              borderBottom: '1px solid var(--accent-blue)', paddingBottom: '2px',
