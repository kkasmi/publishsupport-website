                  ...
                  <div style={{ position: 'relative', width: '200px', height: '200px' }}>
                    ...
                    <style>{`
                      ...
                      @keyframes glowP {
                        ...
                        30% { filter: brightness(1) drop-shadow(0 0 0px #00AAFF); }
                        38% { filter: brightness(1.2) drop-shadow(0 0 20px #00AAFF) drop-shadow(0 0 40px #00AAFF); }
                        72% { filter: brightness(1.2) drop-shadow(0 0 20px #00AAFF) drop-shadow(0 0 40px #00AAFF); }
                        82% { filter: brightness(1) drop-shadow(0 0 0px #00AAFF); }
